...
int main(int argc, char *argv[])
{
	...
	oldMultiplyMatrix(aRows, aCols, bRows, bCols, A, B, &Cgolden);
    if (compareMatrix(aRows, bCols, C, Cgolden)) 
        puts("THE MATRICES ARE THE SAME HELL YEAH");
    else {
        puts("THE MATRICES AREN'T THE SAME. :(");
        printMatrix(aRows, bCols, C);
        printMatrix(aRows, bCols, Cgolden);
    }
